...
const TestimonialsSection = () => {
  return (
    <section id="testimonials" className="py-20 bg-orange-50" data-aos="fade-up">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 grid gap-8 lg:grid-cols-3">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-gray-50 rounded-lg p-8 shadow-sm" data-aos="fade-right">
              <div className="relative">
                ...
                <p className="relative text-lg text-gray-700">{testimonial.content}</p>
              </div>
