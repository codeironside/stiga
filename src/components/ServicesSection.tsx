...
const ServicesSection = () => {
  return (
    <section id="services" className="py-20 bg-orange-50" data-aos="fade-up">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-base text-orange-600 font-semibold tracking-wide uppercase">Services</h2>
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {services.map((service, index) => (
            <div data-aos="fade-right"
              key={index}
              className="relative p-6 bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 hover:bg-orange-100"
            >
              <div>
              ...
              <div className="mt-6 ml-16">
                <a href="#contact" className="text-base font-medium text-blue-600 hover:text-blue-500">
